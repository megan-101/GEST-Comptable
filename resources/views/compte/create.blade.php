...
@section('content')
    <div class="container mt-5">
        <div class="card border border-success shadow-sm" style="max-width: 600px; margin: 0 auto;">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('compte.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{ old('valeur') }}" name="valeur" class="form-control" id="valeur" required>
                    </div>

                    <div class="mb-3">
                        <label for="flag_modif" class="form-label font-weight-bold">Flag Modif</label>
                        <input type="text" value="{{ old('flag_modif') }}" name="flag_modif" class="form-control" id="flag_modif" required>
                    </div>
