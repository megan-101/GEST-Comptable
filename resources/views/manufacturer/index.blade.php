...
@section('content')
    <div class="container mt-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h2 text-">Liste des Manufacturers</h1>
            <a href="{{ route('manufacturer.create') }}" class="btn btn-primary shadow-sm">
                Ajouter un manufacturer
            </a>
        </div>
                    ...
                    <tbody>
                        @forelse ($manufacturers as $manufacturer)
                            <tr>
                                ...
                                <td>{{ $manufacturer->prenom }}</td>
                                <td>{{ $manufacturer->numtel }}</td>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center py-5 text-muted">
                                    <i>Aucun manufacturer n'a été trouvé dans la base de données.</i>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
